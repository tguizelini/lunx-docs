...
exports.TeamsUpdateUseCase = void 0;
...
let TeamsUpdateUseCase = class TeamsUpdateUseCase {
    logger;
    teamsRepository;
    ...
    execute(input) {
        this.logger.log('TeamsUpdateUseCase', 'inicia as validacoes para atualizar um time');
        this.teamsRepository.update(input.id, input);
    }
};
exports.TeamsUpdateUseCase = TeamsUpdateUseCase;
exports.TeamsUpdateUseCase = TeamsUpdateUseCase = __decorate([
...
//# sourceMappingURL=update.use-case.js.map